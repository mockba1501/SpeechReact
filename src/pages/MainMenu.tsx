  ...
  return (
    <div className="flex h-screen items-center justify-center px-3">
      ...
      <button 
        ...
        title={voiceServiceStatus ? "Azure Voice service connected" : "Azure Voice service not connected"}
      >
        {voiceServiceStatus ? (
          <>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 max-md:h-4 max-md:w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span className="max-md:hidden">Azure Voice Service Ready</span>
          </>
        ) : (
          <>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 max-md:h-4 max-md:w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
            ...
            <span className="max-md:hidden">Azure Voice Offline</span>
          </>
        )}
      </button>
    </div>
        ...
        <div className="grid w-full grid-cols-2 gap-6 max-md:grid-cols-1">
          {games.map((game) => (
            ...
            >
              ...
              {/* This section was added without referring back to the game type settings */}
